...
@section('content')
    <div class="container">
        <div class="text-center mb-5 animate__animated animate__fadeIn">
            ...
            <p class="text-muted">Modificá los datos del producto seleccionado.</p>
        </div>
...
@section('scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Obtener ingredientes obligatorios existentes y del old()
            const existingObligatorios = @json($producto->ingredientes->where('pivot.es_obligatorio', 1)->pluck('id')->map(function($id) { return $id . ''; }));
            const oldIngredientesObligatorios = @json(array_keys(old('ingrediente_obligatorio', [])));
            ...
            function updateIngredientesTable() {
                ...
                selectedValues.forEach(function (id) {
                    ...
                    const isChecked = (oldIngredientesObligatorios.includes(id + '') || existingObligatorios.includes(id + '')) ? 'checked' : '';
            ...
            if (window.productoEditado) {
                Swal.fire({
                    icon: 'success',
                    title: '¡Producto actualizado!',
                    text: `El producto "${window.productoEditado}" fue actualizado correctamente.`,
        ...
        @if(session('producto_editado'))
            window.productoEditado = {{ json_encode(session('producto_editado')) }};
        @endif
    </script>
@endsection