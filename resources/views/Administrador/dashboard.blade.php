        ...
        <div class="col-md-4 col-lg-3">
            <div class="card border-0 shadow h-100 hover-scale rounded-4">
                ...
                <div class="card-body text-center">
                    ...
                    <a href="{{ route('productos.index') }}" class="btn btn-outline-success rounded-pill px-4">Gestionar</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4 col-lg-3">
            <div class="card border-0 shadow h-100 hover-scale rounded-4">
                ...
                <div class="card-body text-center">
                    ...
                    <a href="{{ route('categorias.index') }}" class="btn btn-outline-primary rounded-pill px-4">Gestionar</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4 col-lg-3">
            <div class="card border-0 shadow h-100 hover-scale rounded-4">
                ...
                <div class="card-body text-center">
                    ...
                    <a href="{{ route('ingredientes.index') }}" class="btn btn-outline-warning rounded-pill px-4">Gestionar</a>
                </div>
            </div>
        </div>
